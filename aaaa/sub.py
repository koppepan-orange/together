...
r={}
boot_now=tk.Tk()
boot_now.geometry(f"700x300+{int(boot_now.winfo_screenwidth()/2)-350}+{int(boot_now.winfo_screenheight()/2)-150}")
boot_now.overrideredirect(True)
boot_now.attributes("-toolwindow",True)
boot_now.attributes("-topmost", True)
boot_now.resizable(False, False)
rooding_txt=ttk.Label(boot_now, text="ロード中...", font=("ＭＳ ゴシック", 25,"bold"), padding=[10], relief=tk.FLAT)
rooding_txt.place(x=0,y=150)
print("load_start")
boot_now.update()
async def uppppppp():
    while True:
